      ...
      i.Fireworks = class {
        constructor(t) {
          ...
          (this._tick = 0),
            ...
            this.setSize(),
            this.setBoundaries(Object.assign({ x: 50, y: 50 }, s)),
            (this._rocketsPoint = null != f ? f : 50),
            (this._speed = null != p ? p : 2),
            (this._acceleration = null != i ? i : 1.05),
            (this._friction = null != a ? a : 0.95),
            (this._gravity = null != c ? c : 1.5),
            (this._particleCount = null != d ? d : 50),
            (this._traceLength = null != g ? g : 3),
            (this._explosionLength = null != r ? r : 5),
            (this._autoresize = null == e || e),
            (this._hue = Object.assign({ min: 0, max: 360 }, _)),
            (this._mouse = Object.assign({ click: !1, move: !1, max: 3 }, u)),
            (this._delay = Object.assign({ min: 15, max: 30 }, h)),
            ...
            this._canvas.addEventListener("mousedown", (t) =>
              this.useMouse(t, this._mouse.click)
            ),
        ...
        setOptions(t, i) {
          switch (t) {
            ...
            default:
              "object" == typeof i
                ? Object.assign(this["_".concat(t)], i)
                : (this["_".concat(t)] = i);
          }
        }
        setSize() {
        ...
        useMouse(t, i) {
          (this._mouse.click || this._mouse.move) &&
          ...
          this._ctx &&
            ...
            this._visibleBoundaries &&
              ...
              this._ctx.rect(
                this._boundaries.x,
                this._boundaries.y,
                this._boundaries.width - 2 * this._boundaries.x,
                0.5 * this._boundaries.height
              ),
              this._ctx.stroke()),
        ...
        initTrace() {
          (this._ds = h.randomInteger(this._delay.min, this._delay.max)),
            (2 * this._ds < this._tick ||
              ...
              (this._traces.push(
                new s.Trace({
                  ...
                  ctx: this._ctx,
                  hue: h.randomInteger(this._hue.min, this._hue.max),
                  speed: this._speed,
        ...
        drawTrace() {
          for (var t = this._traces.length; t--; )
            this._traces[t].draw(),
              this._traces[t].update((i, e, s) => {
                this.initExplosion(i, e, s),
                  this._sound.play(),
                  this._traces.splice(t, 1);
              });
        }
        initExplosion(t, i, e) {
          for (var s = this._particleCount; s--; )
      ...
      i.Trace = class {
        constructor(t) {
          ...
          for (
            this._coordinates = [],
              ...
              this._traceLength = _,
              this._totalDistance = this.getDistance(i, e, n, o);
            this._traceLength--;

          )
            this._coordinates.push([i, e]);
          (this._angle = Math.atan2(o - e, n - i)),
            (this._brightness = s.randomInteger(50, 70));
        }
        update(t) {
        ...
        draw() {
          ...
          this._ctx.beginPath(),
            ...
            (this._ctx.strokeStyle = "hsl("
              .concat(this._hue, ", 100%, ")
              .concat(this._brightness, "%)")),
            this._ctx.stroke();
        }
        getDistance(t, i, e, s) {
          var n = Math.pow;
            ...
            if (this.options.enable)
              if (this._buffer.length) {
                var t = this._audioContext.createBufferSource(),
                  i = this._buffer[n.randomInteger(0, this._buffer.length - 1)],
                  e = this._audioContext.createGain();
                (t.buffer = i),
                  (e.gain.value = n.randomFloat(
        ...
        constructor(t) {
          ...
          for (
            this._coordinates = [],
              ...
              this._friction = h,
              this._gravity = r,
              this._explosionLength = a;
            this._explosionLength--;

          )
            this._coordinates.push([i, e]);
          (this._angle = s.randomFloat(0, 2 * Math.PI)),
            (this._speed = s.randomInteger(1, 10)),
            (this._hue = s.randomInteger(o - 20, o + 20)),
            (this._brightness = s.randomInteger(c.min, c.max)),
            (this._decay = s.randomFloat(c.decay.min, c.decay.max));
        }
        update(t) {
          this._coordinates.pop(),
            this._coordinates.unshift([this._x, this._y]),
